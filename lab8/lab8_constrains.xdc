...
# Switches
set_property PACKAGE_PIN V17 [get_ports {start_move}]
set_property IOSTANDARD LVCMOS33 [get_ports {start_move}]
set_property PACKAGE_PIN V16 [get_ports {start_right_move}]
set_property IOSTANDARD LVCMOS33 [get_ports {start_right_move}]
set_property PACKAGE_PIN W16 [get_ports {start_left_move}]
set_property IOSTANDARD LVCMOS33 [get_ports {start_left_move}]
